                ...
                <div class="card">
                    <div class="card-body p-6">
                        <div class="space-y-6">
                            ...
                            <a href="{{ route('general-settings.edit') }}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                    dark:text-slate-300">
                ...
                <div class="card">
                    <div class="card-body p-6">
                        <div class="space-y-6">
                            ...
                            <a href="{{ route('users.index') }}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                    dark:text-slate-300">
                ...
                <div class="card">
                    <div class="card-body p-6">
                        <div class="space-y-6">
                            ...
                            <a href="{{ route('roles.index') }}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                    dark:text-slate-300">
                                <span>Change Settings</span>
                                <iconify-icon icon="heroicons:arrow-right"></iconify-icon>
                            </a>
                ...
                <div class="card">
                    <div class="card-body p-6">
                        <div class="space-y-6">
                            ...
                            <a href="{{ route('permissions.index') }}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                    dark:text-slate-300">
                                <span>Change Settings</span>
                                <iconify-icon icon="heroicons:arrow-right"></iconify-icon>
                            </a>
                ...
                <div class="card">
                    <div class="card-body p-6">
                        <div class="space-y-6">
                            ...
                            <a href="{{ route('profiles.index') }}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                    dark:text-slate-300">
                                <span>Change Settings</span>
                                <iconify-icon icon="heroicons:arrow-right"></iconify-icon>
                            </a>
                ...
                <div class="card">
                    <div class="card-body p-6">
                        <div class="space-y-6">
                            ...
                            <div class="text-slate-600 dark:text-slate-300 text-sm">
                                Backup database tables for entire application
                            </div>
                            <a href="{{ route('database-backups.index') }}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                    dark:text-slate-300">
