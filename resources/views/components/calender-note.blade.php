...
@endphp
<div class="mb-12">
    <div id="unmeb-mini-calendar"></div>
</div>
    ...
    <li class="block py-[10px]">
        <div class="flex space-x-2 rtl:space-x-reverse">
            <div class="flex-1 flex space-x-2 rtl:space-x-reverse">
                <div class="flex-none">
                    <div class="h-8 w-8">
                        <img src={{ $item['img'] }} alt="" class="block w-full h-full object-cover rounded-full border hover:border-white border-transparent">
                    </div>
                </div>
                <div class="flex-1">
...
<script type="module">
    $("#unmeb-mini-calendar").zabuto_calendar({
