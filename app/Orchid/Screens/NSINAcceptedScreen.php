        ...
        $query = NsinRegistration::with([
            ...
            'studentRegistrationNsin' => function ($query) {
                $query->selectRaw('nsinregistration_id,
                    SUM(CASE WHEN s.gender = "Female" AND students_registration_nsin.verify = 1 THEN 1 ELSE 0 END) as approved_females,
                    SUM(CASE WHEN s.gender = "Male" AND students_registration_nsin.verify = 1 THEN 1 ELSE 0 END) as approved_males,
