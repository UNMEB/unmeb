...
class NSINAcceptedScreen extends Screen
{
    /**
    ...
    public function query(): iterable
    {
        $query = NsinRegistration::query()
            ->select(
                ...
                DB::raw('IFNULL(accepted_females, 0) AS accepted_females'),
                DB::raw('IFNULL(accepted_males, 0) AS accepted_males'),
            ...
            ->leftJoinSub(function ($query) {
                $query->select(
                    ...
                    DB::raw('SUM(CASE WHEN s.gender = "Female" AND student_registration_nsins.verify = 1 THEN 1 ELSE 0 END) AS accepted_females'),
                    DB::raw('SUM(CASE WHEN s.gender = "Male" AND student_registration_nsins.verify = 1 THEN 1 ELSE 0 END) AS accepted_males'),
            ...
            ->where('nsin_registrations.nsin_verify', 1)
    ...
    {
        return 'Accepted NSIN Student Registrations';
    }
