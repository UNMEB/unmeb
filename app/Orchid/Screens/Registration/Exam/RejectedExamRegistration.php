...
class RejectedExamRegistration extends Screen
{
    /**
    ...
    public function query(): iterable
    {
        $query = Registration::query()
            ->select([
                ...
                'rp.reg_start_date',
                'rp.reg_end_date',
                DB::raw("(SELECT COUNT(*) FROM student_registrations WHERE registration_id = r.id AND sr_flag = 0) as rejected_students")
            ])
    ...
    {
        return 'Rejected ExamRegistration';
    }
