...
class AcceptedExamRegistrationDetails extends Screen
{
    public $registration;
    ...
    public function filter(Request $request)
    {
        ...
        $url = route('platform.registration.exam.accepted.details', $queryParams);
    ...
    {
        return redirect()->route('platform.registration.exam.accepted.details');
    }
}
